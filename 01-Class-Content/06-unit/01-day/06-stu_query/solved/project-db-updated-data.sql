...
--Data being added to each table --
...
-- UPDATE DATA IN EACH OF THE THREE COLUMNS --
...
-- WRITE AN UPDATE STATEMENT THAT UPDATES MULTIPLE FIELDS AT ONCE --
